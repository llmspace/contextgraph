//! Basic UTL computation handlers.
//!
//! Provides handlers for utl/compute and utl/metrics requests.
...
impl Handlers {
    ...
    pub(crate) async fn handle_utl_compute(
        &self,
        id: Option<JsonRpcId>,
    ...
    pub(crate) async fn handle_utl_metrics(
        &self,
        id: Option<JsonRpcId>,
        params: Option<serde_json::Value>,
    ) -> JsonRpcResponse {
