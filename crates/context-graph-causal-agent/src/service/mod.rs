...
impl CausalDiscoveryService {
    ...
    async fn process_candidate_with_store(
        ...
        if let Some(store) = store {
            ...
            // CA-M2 FIX: Use empty Vec instead of 4KB zero placeholder.
            // E1 embedding is NOT generated by the storage layer — it stores
            // whatever we pass. An empty vec clearly signals "not populated"
            // and avoids allocating 4KB of heap memory per relationship.
            let e1_semantic = Vec::new();
